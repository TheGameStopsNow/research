...
![The complete system: seven layers from phantom locates to algorithmic fingerprint](figures/chart_complete_picture.png)
...
BNY Mellon's **Dreyfus Government Cash Management** fund is one of the largest money market funds in the world. It takes investor cash and lends it to prime broker banks through triparty repos. Using the SEC's own N-MFP filings, I pulled every monthly datapoint from December 2019 through May 2022.
...
Using 2,038 days of tick-level options data, I found a DMA routing fingerprint: 1-lot trades, sub-$0.10 prices, monotonic sequencing at 90%+, operating on exactly two exchanges. It runs on **31 stocks**, including SPY, AAPL, NVDA, and GME.
