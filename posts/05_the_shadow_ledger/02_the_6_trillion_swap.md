...
These aren't random counterparties. They are the exact 8 banks that serve as prime brokers for the largest derivative positions on the planet. Six of eight are JGB Primary Dealers, the firms that provide yen funding for the carry trade. And when the yen carry trade blew up in August 2024, every single one of these banks was exposed.
...
- **Diameter Capital's principals** include former Citadel portfolio managers
...
> *"The few who understand the system will either be so interested in its profits or so dependent on its favors that there will be no opposition from that class.", Mayer Amschel Rothschild*
