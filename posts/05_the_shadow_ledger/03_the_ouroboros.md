...
In 2023, **Cantor Fitzgerald** became the primary custodian for **Tether's U.S. Treasury reserves**. Tether (USDT) is the largest stablecoin by market cap (~$140B as of early 2026), claiming each token is backed 1:1 by U.S. dollars and Treasury securities. Cantor's role is to manage this reserve portfolio.
