...
**Wolverine Trading** is the confirmed **[Designated Primary Market Maker (DPM)](https://www.cboe.com/us/options/membership/market_maker/)** for GME options on Cboe. In 2013, the SEC brought [Administrative Proceeding No. 3-15519](https://www.sec.gov/litigation/admin/2013/34-70394.pdf) against Wolverine for conducting pre-arranged transactions designed solely to reset the Reg SHO settlement clock, the identical mechanical profile observed in the DMA fingerprint.
...
| Post | Layer | Evidence |
| --- | --- | --- |
| **Part 1** | Synthetic Supply | FTX tokenized stocks; zero GME in SOAL; 3.6× FTD spike |
...
> **⚠️ A note on what follows.** Parts 1-7 were forensic accounting. Every claim had a regression, a filing, or a control test behind it. What comes next is different. *The Counter-Signal* is a companion series that presents the evidence that *someone has been writing back into the very system Parts 1-7 documented*, embedding numbers and structures into the options chain using the same infrastructure. The evidence is real and verifiable. The interpretation requires a leap that some readers will be unwilling to make, and I respect that. Parts 1-7 stand on their own regardless. If you continue, you're choosing to follow the speculation to its conclusion.

Continue on to *The Counter-Signal*, Part 1: [The Signature](../08_the_counter_signal/01_the_signature.md)...
