...
![The algo concentrates exclusively on **MIAX Pearl** and **Nasdaq BX** — two venues with distinct pricing structures that create specific routing incentives:](figures/table_05_07_the_fingerprint.png)
